...
dossier = "/Users/abarrier/Documents/Scolaire/ENS/L3/Cours/Stage/Python"
...
def reestimation_globale(x_exact=False, theta_exact=False, affichage=False):
    ...
    M = csr_matrix(np.concatenate((A, B), axis=1))
...
for n in range(Nexp):
    C_reel, X_reel, theta_reel, theta_0, theta_a, x_reel, x_0, x_a = reestimation_globale()
